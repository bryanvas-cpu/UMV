...
float socfun(float v,float i,float t){
  ...
  ocv = ocvfun(v,i);
  q = q + i*(t-t_prev)/1000;
  cc = s0-(q*0.95)*100/3000; //5948.342032632134
  // Serial.print("CC : ");
  // Serial.print(cc);
  // Serial.print(" OCV : ");
  // Serial.println(ocv);
...
//  Serial.println(acceleration);
  ...
  //////////////////////////////////delay&motors////////////////////////////////////////
  str = "&" + (String)inclination + "%" + (String)ambient_temp + "%" + (String)speed + "%" + (String)weight + "%" + (String)battery_level + "%" + (String)battery_temp + "%" + (String)timee + "%" + (String)battery_rating + "%" + (String)charging_cycle + "%" + (String)acceleration + "%" + (String)battery_voltage + "%" + (String)battery_current + "%" + (String)humidity + "%" + (String)q + "%" + (String)V + "%" + (String)cc + "%" +(String)ocv;
  Serial.println(str);
